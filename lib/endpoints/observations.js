...
var observations = class observations {
  ...
  static setQualityMetric( params, options ) {
    return iNaturalistAPI.basicPost( "observations/:id/quality/:metric", params, options );
  }

  static deleteQualityMetric( params, options ) {
    return iNaturalistAPI.basicDelete( "observations/:id/quality/:metric", params, options );
  }
