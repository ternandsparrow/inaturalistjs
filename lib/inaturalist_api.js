...
var iNaturalistAPI = class iNaturalistAPI {
  ...
  static basicPost( route, params, options ) {
    ...
    return fetch( `http://${ options.rails ? iNaturalistAPI.railsApiHost : iNaturalistAPI.nodeApiHost }/${ route }`, {
      method: (options.method || "post"),
      credentials: ( headers.Authorization ? null : "same-origin" ),
      headers: headers,
